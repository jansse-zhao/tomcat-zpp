...
public class Http11Processor extends AbstractProcessor {
    ...
    public SocketState service(SocketWrapperBase<?> socketWrapper) throws IOException {
        ...
        while (!getErrorState().isError() && keepAlive && !isAsync() && upgradeToken == null &&
            ...
            // 处理高版本的http协议，比如http2
            // 如果请求头中存在Connection=“upgrade”的键值对，则进入判断
            if (isConnectionToken(request.getMimeHeaders(), "upgrade")) {
                // Check the protocol
                // 读取请求头中具体Upgrade的值，也就是具体的http版本
    ...
    /**
     * 当是高版本http协议是，clone当前版本请求到高版本请求中
     */
    ...
    private static boolean isConnectionToken(MimeHeaders headers, String token) throws IOException {
        ...
        Set<String> tokens = new HashSet<>();
        // 解析请求头中Connection属性，是否包含token=“upgrade”
        TokenList.parseTokenList(headers.values(Constants.CONNECTION), tokens);
